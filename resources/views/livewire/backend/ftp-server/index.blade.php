    ...
    <div class="col-lg-4 mb-5">
        <div class="card">
            ...
            <div class="card-body">
                <form action="">
                    @if($server)
                    <input type="hidden" wire:model="serverId">
                    @endif
                    ...
                    <table class="table mb-0 text-nowrap table-centered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ $server->link }}" target="_blank">{{ $server->link }}</a>
                                </td>
                                <td>
                                    <button wire:click="edit({{$server->id}})" class="btn btn-primary btn-sm">
                                        <i class="icon-edit feather"></i>
                                    </button>
                                    <button wire:click="getDeleteId({{ $server->id }})" data-bs-toggle="modal" data-bs-target="#deleteModal" class="btn btn-danger btn-sm">
